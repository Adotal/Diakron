      ...
      switch (_currentFilter) {
        case CollectionFilterType.date:
          if (dateRange != null) {
            ...
            final start = dateRange!.start.subtract(const Duration(days: 1)).toLocal();
            final end = dateRange!.end.add(const Duration(days: 1)).toLocal();
            if (c.collDate.toLocal().isBefore(start) || c.collDate.toLocal().isAfter(end)) {
              return false;
            }
          }
          break;
