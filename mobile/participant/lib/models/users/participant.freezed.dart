...
@override
String toString() {
  return 'Participant(id: $id, email: $email, userName: $userName, surnames: $surnames, phoneNumber: $phoneNumber, isActive: $isActive, userType: $userType, createdAt: $createdAt, points: $points, phrase: $phrase)';
}
...
class _Participant implements Participant {
  const _Participant({required this.id, required this.email, required this.userName, required this.surnames, required this.phoneNumber, required this.isActive, required this.userType, required this.createdAt, required this.points, @JsonKey(includeToJson: false) this.phrase});
