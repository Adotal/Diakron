...
class AdminsScreen extends StatefulWidget {
  const AdminsScreen({super.key, required this.viewModel});

  final AdminsViewModel viewModel;
...
class _AdminsScreenState extends State<AdminsScreen> {
  ...
  @override
  void didUpdateWidget(covariant AdminsScreen oldWidget) {
    if (!widget.viewModel.load.running &&
        widget.viewModel.load.result == null) {
      widget.viewModel.load.execute();
    }
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount: widget.viewModel.admins.length,
                      itemBuilder: (context, index) {
                        final admin = widget.viewModel.admins[index];
                        ...
                        return Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              borderRadius: BorderRadius.circular(16),
                              onTap: () {
                                context.push(Routes.adminById(admin.id!));
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(
                                  vertical: 8,
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: Text(
                                    'Superadmin: ${admin.isSuperadmin! ? 'Sí' : 'No'}',
                                  ...
                                  trailing: _buildStatusIcon(admin.isActive!),
                                ),
                              ),
                            ),
                          ),
