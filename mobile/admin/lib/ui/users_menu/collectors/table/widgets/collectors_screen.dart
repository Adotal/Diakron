...
class CollectorsScreen extends StatefulWidget {
  const CollectorsScreen({super.key, required this.viewModel});

  final CollectorsViewModel viewModel;
...
class _CollectorsScreenState extends State<CollectorsScreen> {
  ...
  @override
  void didUpdateWidget(covariant CollectorsScreen oldWidget) {
    if (!widget.viewModel.load.running &&
        widget.viewModel.load.result == null) {
      widget.viewModel.load.execute();
    }
          ...
          if (widget.viewModel.load.error) {
            return Center(
              child: ErrorIndicator(
                title: 'Error al cargar Recolectores',
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount: widget.viewModel.collectors.length,
                      itemBuilder: (context, index) {
                        final collector =
                            widget.viewModel.collectors[index];
                        ...
                        return Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              borderRadius: BorderRadius.circular(16),
                              onTap: () {
                                context.push(Routes.collectorById(collector.id!));
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(
                                  vertical: 8,
