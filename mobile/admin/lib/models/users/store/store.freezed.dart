...
@JsonKey(includeToJson: false) String? get email;// Validation status
 ...
 String? get pathLogo; String? get pathIdRep; String? get pathProofAddress; String? get pathTaxCertificate;// This properties ared needed for store, but not manually stored in DB
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,email,validationStatus,id,userName,surnames,phoneNumber,isActive,userType,createdAt,companyName,commercialName,rfc,taxRegime,taxpayerType,address,category,bank,clabe,billingEmail,postCode,const DeepCollectionEquality().hash(_schedule),pathLogo,pathIdRep,pathProofAddress,pathTaxCertificate,pointsExchanged,firstExchangesParticipant]);
